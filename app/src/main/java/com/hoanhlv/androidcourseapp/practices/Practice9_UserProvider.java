...
import com.hoanhlv.androidcourseapp.database.UserContract;
import com.hoanhlv.androidcourseapp.database.manager.DbManager;

public class Practice9_UserProvider extends ContentProvider {
    private final String AUTHORITY = "com.hoanhlv.Practice9_UserProvider";
